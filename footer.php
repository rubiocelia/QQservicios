...
window.addEventListener('beforeunload', function(event) {
    ...
    navigator.sendBeacon('heartbeat.php', 'id_usuario=' + encodeURIComponent(sessionStorage.getItem(
        'id_usuario')));
});
</script>
...
<footer class="footer">
    <div class="footer-content">
        <div class="logoTexto">
            <img src="./archivos/logoQQ.png" alt="QuidQualitas Logo" class="footer-logo">
            <p class="footer-text">Quid Qualitas<br>Inspiring Customer Experiences</p>
            <div class="socials">
                <a href="#"><img class="rrss" src="./archivos/linkedin.png" alt="linkeding" target="_blank"></a>

                <a href="#"><img class="rrss" src="./archivos/instagram.png" alt="instagram" target="_blank"></a>

                <a href="#"><img class="rrss" src="./archivos/facebook.png" alt="facebook" target="_blank"></a>

                <a id="openPopupFooter"><img class="rrss" src="./archivos/llamada.png" alt="llamadas"
                        target="_blank"></a>
        ...
        <div class="footer-section contact-form">
            <h2>CONTACTO</h2>
            <p><img class="iconoFooter" src="./archivos/ubicacion.png" alt="linkeding"> C. de Eugenio Salazar, 14,
                28002
                Madrid</p><br>
            <p><img class="iconoFooter" src="./archivos/correo.png" alt="linkeding">inspiring@quidqualitas.es</p>
            <br>
            <p><img class="iconoFooter" src="./archivos/telefono.png" alt="linkeding">+34 681 31 10 37</p>
        </div>
    </div>
